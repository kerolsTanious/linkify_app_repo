...
class AdminGetProductBody extends StatefulWidget {
  const AdminGetProductBody({super.key, required this.brandId});

  @override
  State<AdminGetProductBody> createState() => _AdminGetProductBodyState();
  final String brandId;
}

class _AdminGetProductBodyState extends State<AdminGetProductBody> {
