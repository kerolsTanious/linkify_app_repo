...
import 'package:linkify_app/features/home/data/model/search_model/SearchData.dart';

class ProductListViewItemSearch extends StatelessWidget {
  const ProductListViewItemSearch({
    super.key,
    required this.productData,
    required this.index,
  });

  final SearchData productData;
  final int index;
