...
import 'package:linkify_app/features/home/presentation/view_model/get_all_categories_state.dart';
...
class GetAllCategoriesCubit extends Cubit<GetAllCategoriesState> {
  ...
  Future<void> getAllCategories() async {
    ...
    result.fold(
      (response) {
        emit(GetAllCategoriesSuccess(getAllCategoriesResponse: response));
      },
      (error) {
